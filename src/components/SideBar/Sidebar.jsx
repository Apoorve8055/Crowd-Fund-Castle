...
const SideBar = ({ isMenuOpen, setIsMenuOpen }) => {
  ...
  return (
    ...
    >
      <div className="w-screen bg-light-backgroundColor p-4 flex flex-col items-center dark:bg-dark-cardBgColor sm:m-4 sm:w-20 lg:justify-between sm:h-80vh sm:shadow-custom sm:rounded-3xl">
